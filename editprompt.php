...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $_POST['_method'] ?? '' === 'put') {
    ...
    // echo '' . $title . '' . $note . '';
    $query = 'UPDATE prompts SET author=:author, title = :title, prompt = :prompt WHERE id = :id';
...
<body class="bg-slate-400 flex flex-col min-h-screen">
    ...
    <div class="flex-grow container mx-auto px-2 bg-slate-400 min-h-[100%]">
        ...
        <h1 class="text-center text-5xl my-2 text-orange-400 underline decoration-orange-400">Edit Prompt</h1>
